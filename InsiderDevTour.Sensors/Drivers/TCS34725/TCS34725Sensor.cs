...
namespace InsiderDevTour.Sensors.Drivers.TCS34725

{
    ...
    public class TCS34725Sensor
    {
        ...
        public TCS34725Sensor(int ledControlPin = 12)
        {
        ...
        public async Task<KnownColor> GetClosestColor()
        {
            //Create an object to store the raw color data
